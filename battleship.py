    ...
    if ships_placed < 5:
        if toggle == 1:
            pygame.draw.rect(
                ...
                (
                    x_pos,
                    y_pos,
                    cell_dimension * player_ships[ships_placed].dimension,
                    cell_dimension,
                ),
            )
        else:
            ...
            if event.type == pygame.QUIT:
                ...
                if event.button == 1:  # Click Sinistro
                    ...
                    if (
                        ...
                        and ships_placed < len(player_ships)
                    ):
                        if (
                            toggle == 1
                            and col + player_ships[ships_placed].dimension > 10
                        ):
                            print("You can't place player_ships here!")
                        elif (
                            toggle == -1
                            and row + player_ships[ships_placed].dimension > 10
                        ):
                            print("You can't place player_ships here!")
                        else:
                            trovato = False
        ...
        for r in range(num_rows):
            for c in range(num_columns):
                ...
                pygame.draw.rect(
                    display, (0, 0, 0), (x, y, cell_dimension, cell_dimension), 1
                )  # Bordo
